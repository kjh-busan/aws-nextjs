...
function (_Document) {
  ...
  _createClass(MyDocument, [{
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement("html", htmlAttrs, external_react_default.a.createElement("head", null, this.props.styleTags, values_default()(helmet).map(function (el) {
        return el.toComponent();
      })), external_react_default.a.createElement("body", bodyAttrs, external_react_default.a.createElement(next_document["Main"], null), external_react_default.a.createElement(next_document["NextScript"], null)));
    }
  }], [{
    key: "getInitialProps",
